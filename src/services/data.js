export const gameData = {
    ...
    generateData(maxRounds, nameP1, nameP2) {
        return {
            ...
            roundNumber: 1,
            gameover: false,
            p1: { nickname: nameP1, score: 0 },
            p2: { nickname: nameP2, score: 0 }
        };
    },
    ...
    nextRound(last_round) {
        ...
        if (
            Math.trunc(data.maxRounds / 2) < players_data.p1.score ||
            Math.trunc(data.maxRounds / 2) < players_data.p2.score
        ) {
            return {
